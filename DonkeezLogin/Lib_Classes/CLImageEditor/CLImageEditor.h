...
#define NotificationOptionPublicOrPrivate @"NotificationOptionPublicOrPrivate"
...
- (void)imageEditor:(CLImageEditor*)editor didFinishEdittingWithImage:(UIImage*)image isPrivate:(BOOL)isPrivate;
