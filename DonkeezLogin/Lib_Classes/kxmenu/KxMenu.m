...
- (UIView *) mkContentView
{
    ...
    //    contentView.backgroundColor = BD_MAIN_FORE_COLOR;
...
+ (UIImage *) selectedImage: (CGSize) size
{
    ...
    //    };
    const CGFloat components[] = {
        140./255., 30./255., 118./255., 1,
        216./255., 181./255., 201./255., 1,
    };
             ...
             inContext:(CGContextRef) context
{
    ...
    CGFloat R0 = 158./255., G0 = 66./255., B0 = 138./255.;
    CGFloat R1 = 216./255., G1 = 181./255., B1 = 201./255.;
    ...
    const CGFloat locations[] = {0, 0.1, 0.9, 1};
    const CGFloat components[] = {
        R1, G1, B1, 1,
        R0, G0, B0, 1,
        R0, G0, B0, 1,
