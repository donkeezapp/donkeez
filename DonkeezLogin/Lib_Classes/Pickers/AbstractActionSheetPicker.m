...
//                                                               action:@selector(actionPickerCancel:)];
        ...
        UIBarButtonItem *sysDoneButton = [[UIBarButtonItem alloc] initWithTitle:@"OK" style:UIBarButtonItemStyleDone target:self action:@selector(actionPickerDone:)];
        
        
        UIBarButtonItem *sysCancelButton = [[UIBarButtonItem alloc] initWithTitle:@"Cancel" style:UIBarButtonItemStyleDone target:self action:@selector(actionPickerCancel:)];
